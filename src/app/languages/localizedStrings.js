...
export const strings = new LocalizedStrings({
  en: {
    ...
    errorPermissionDeniedMicrophone:
      "An error occurred when joining the conference. Please make sure to allow access to your microphone.",
    errorPermissionDeniedMicrophoneCamera:
      'An error occurred when joining the conference. Please make sure to allow access to your microphone and camera. Check if there’s another application using your camera and microphone',
    ...
    browserNotSupported: 'This browser is currently not supported.',
    ...
    broadcastLive: 'Broadcast is live',
    ...
    enterhere: 'Enter your information here:',
    ...
    errorFilePresentation:
      "An error occurred during the file presentation. Please check your file.",
